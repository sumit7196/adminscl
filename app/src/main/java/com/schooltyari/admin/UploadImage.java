...
public class UploadImage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Category  in gallery its time its static
        String[] items = new String[]{"Select Category", "Convocation", "Independence Day", "Annual Day"};
        ...
        uploadImage.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (bitmap == null) {
                    Toast.makeText(UploadImage.this, "Please uplaod image", Toast.LENGTH_SHORT).show();
